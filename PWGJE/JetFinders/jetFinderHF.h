...
struct JetFinderHFTask {
  ...
  void processChargedJetsMCP(o2::soa::Filtered<o2::aod::JetMcCollisions>::iterator const& collision,
  ...
  void processChargedEvtWiseSubJetsMCP(o2::soa::Filtered<o2::aod::JetMcCollisions>::iterator const& collision,
                                       o2::soa::Filtered<JetParticlesSubTable> const& particles,
                                       CandidateTableMCP const& candidates)
  {
    for (typename CandidateTableMCP::iterator const& candidate : candidates) {
