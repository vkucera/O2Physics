...
struct JetFinderTask {
  ...
  o2::framework::expressions::Filter collisionFilter = (nabs(o2::aod::jcollision::posZ) < vertexZCut && o2::aod::jcollision::centFT0M >= centralityMin && o2::aod::jcollision::centFT0M < centralityMax && o2::aod::jcollision::trackOccupancyInTimeRange <= trackOccupancyInTimeRangeMax && ((skipMBGapEvents.node() == false) || (o2::aod::jcollision::subGeneratorId != static_cast<int>(jetderiveddatautilities::JCollisionSubGeneratorId::mbGap))));
  o2::framework::expressions::Filter mcCollisionFilter = ((skipMBGapEvents.node() == false) || (o2::aod::jmccollision::subGeneratorId != static_cast<int>(jetderiveddatautilities::JCollisionSubGeneratorId::mbGap)));                                                                // should we add a posZ vtx cut here or leave it to analysers?
  ...
  void processParticleLevelChargedJets(o2::soa::Filtered<o2::aod::JetMcCollisions>::iterator const& collision, o2::soa::Filtered<o2::aod::JetParticles> const& particles)
  {
  ...
  void processParticleLevelChargedEvtWiseSubJets(o2::soa::Filtered<o2::aod::JetMcCollisions>::iterator const& collision, o2::soa::Filtered<o2::aod::JetParticlesSub> const& particles)
  {
    // TODO: MC event selection?
    inputParticles.clear();
  ...
  void processParticleLevelNeutralJets(o2::soa::Filtered<o2::aod::JetMcCollisions>::iterator const& collision, o2::soa::Filtered<o2::aod::JetParticles> const& particles)
  {
    // TODO: MC event selection?
    inputParticles.clear();
  ...
  void processParticleLevelFullJets(o2::soa::Filtered<o2::aod::JetMcCollisions>::iterator const& collision, o2::soa::Filtered<o2::aod::JetParticles> const& particles)
  {
    // TODO: MC event selection?
    inputParticles.clear();
