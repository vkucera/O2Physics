...
using DplusChargedJetMatchingSub = JetMatchingSub<soa::Join<aod::DplusChargedJets, aod::DplusChargedJetConstituents>,
                                                  ...
                                                  aod::DplusChargedEventWiseSubtractedJetsMatchedToDplusChargedJets,
                                                  aod::JTrackDplusSubs,
...
WorkflowSpec defineDataProcessing(ConfigContext const& cfgc)
{
  ...
  tasks.emplace_back(adaptAnalysisTask<DplusChargedJetMatchingSub>(cfgc, TaskName{"jet-matching-sub-dplus-ch"}));
