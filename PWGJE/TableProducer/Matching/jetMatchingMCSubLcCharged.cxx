...
// jet matching mc subtracted Lc charged task
//
...
using LcChargedJetMatchingMCSub = JetMatchingMcSub<soa::Join<aod::LcChargedMCDetectorLevelJets, aod::LcChargedMCDetectorLevelJetConstituents>,
...
WorkflowSpec defineDataProcessing(ConfigContext const& cfgc)
{
  ...
  tasks.emplace_back(adaptAnalysisTask<LcChargedJetMatchingMCSub>(cfgc, TaskName{"jet-matching-mc-sub-lc-ch"}));
