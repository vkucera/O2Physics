...
using JetCollision = aod::JetCollisions::iterator;
using JetCollisionsMCD = o2::soa::Join<aod::JetCollisions, JMcCollisionLbs>;
using JetTracks = JTracks;
using JetTracksMCD = o2::soa::Join<aod::JetTracks, JMcTrackLbs>;
...
using JetMcCollision = aod::JetMcCollisions::iterator;
