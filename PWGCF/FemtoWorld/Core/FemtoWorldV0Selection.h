...
void FemtoWorldV0Selection::init(o2::framework::HistogramRegistry* registry)
{
  if (registry) {
    ...
    mHistogramRegistry->add((folderName + "/hInvMassLambda").c_str(), "", o2::framework::kTH1F, {massAxisLambda});
    mHistogramRegistry->add((folderName + "/hInvMassAntiLambda").c_str(), "", o2::framework::kTH1F, {massAxisAntiLambda});
    mHistogramRegistry->add((folderName + "/hInvMassLambdaAntiLambda").c_str(), "", o2::framework::kTH2F, {massAxisLambda, massAxisAntiLambda});
    ...
    mHistogramRegistry->add("LambdaQA/hInvMassLambdaNoCuts", "No cuts", o2::framework::kTH1F, {massAxisLambda});
    mHistogramRegistry->add("LambdaQA/hInvMassLambdaInvMassCut", "Invariant mass cut", o2::framework::kTH1F, {massAxisLambda});
    mHistogramRegistry->add("LambdaQA/hInvMassLambdaPtMin", "Minimum Pt cut", o2::framework::kTH1F, {massAxisLambda});
    mHistogramRegistry->add("LambdaQA/hInvMassLambdaPtMax", "Maximum Pt cut", o2::framework::kTH1F, {massAxisLambda});
    mHistogramRegistry->add("LambdaQA/hInvMassLambdaDCAV0Daugh", "V0-daughters DCA cut", o2::framework::kTH1F, {massAxisLambda});
