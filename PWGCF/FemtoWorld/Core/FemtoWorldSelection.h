...
class FemtoWorldSelection
{
 public:
  ...
  FemtoWorldSelection(selValDataType selVal, selVariableDataType selVar, femtoWorldSelection::SelectionType selType)
    : mSelVal(selVal),
      mSelVar(selVar),
      mSelType(selType)
  {
  ...
  /// Destructor
  virtual ~FemtoWorldSelection() = default;
  ...
  femtoWorldSelection::SelectionType getSelectionType() { return mSelType; }
 ...
 private:
  ...
  femtoWorldSelection::SelectionType mSelType; ///< Type of selection employed
};
