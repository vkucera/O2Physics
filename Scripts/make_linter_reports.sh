...
cmd_cppcheck="$HOME/projects/cppcheck/cppcheck/build_Release/bin/cppcheck {} --language=c++ --std=c++20 --enable=style --check-level=exhaustive --suppressions-list=cppcheck_config --inline-suppr --force"
