...
cmd_cppcheck="$HOME/projects/cppcheck/cppcheck/build_Release/bin/cppcheck {} --language=c++ --std=c++20 --enable=warning --check-level=exhaustive --suppressions-list=cppcheck_config --force"
